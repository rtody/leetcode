# Version 2, function getImportance() takes list of Employee objects as parameters
...
class Solution:
    ...
    def getImportance(self, employees, id):
        ...
        empl_attr_lst = list()
        for e in employees:
            empl_attr_lst.append([e.id, e.importance, e.subordinates])
        
        empl_id_lst = [empl_info.id for empl_info in employees]
        print(empl_id_lst)
        ...
        self.calc_subord_impt(empl_attr_lst, empl_id_lst, start_id_loc)
...
solution = Solution()
solution.getImportance([empl_A, empl_B, empl_C], 1)
